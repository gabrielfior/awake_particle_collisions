...
filename = '/Users/gabrielfior/data_mpp2/Rb_10GeV_normal_density_Monolayer/VACANCY.txt' 
#print dir1
...
for i in x:
    ...
    recoils.append(np.double(i.split(' ')[4]))
...
print 'Ionization: '+str(sum_ioniz) + ' MeV'
