  ...
  : G4UserRunAction(), fAnalysisManager(0), fRun(0)
{
  ...
  fAnalysisManager->SetFileName("1cm_1e6_400GeV_Rb10minus4_beam_cut1_5mm");
  //fAnalysisManager->SetFileName("10cm_1e6_400GeV_Rb10minus7_beam_cut1_5mm");
  //fAnalysisManager->setNtupleDirName("/media/sf_UNTITLED23/");
...
void RunAction::Book()
{
  ...
  */
  fAnalysisManager->CreateNtuple("B4_g", "many_things");
  ...
  fAnalysisManager->CreateNtupleIColumn("stepNumber");
  fAnalysisManager->CreateNtupleDColumn("posX");
  fAnalysisManager->CreateNtupleDColumn("posY");
  fAnalysisManager->CreateNtupleDColumn("posZ(mm)");
  fAnalysisManager->CreateNtupleDColumn("perp");
  fAnalysisManager->CreateNtupleDColumn("kineeticEnergyDiff(eV)");
  fAnalysisManager->CreateNtupleDColumn("edepStep(eV)");
  fAnalysisManager->CreateNtupleDColumn("kineticEnergyPostStep(eV)");  
  fAnalysisManager->CreateNtupleSColumn("processName"); 
  ...
  fAnalysisManager->CreateNtupleDColumn("momdirx");
  fAnalysisManager->CreateNtupleDColumn("momdiry");
  fAnalysisManager->CreateNtupleDColumn("momdirz");
  fAnalysisManager->CreateNtupleDColumn("stepLength");
  fAnalysisManager->CreateNtupleDColumn("totalEnergyDeposit");  
