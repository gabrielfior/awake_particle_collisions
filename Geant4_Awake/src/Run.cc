...
fEdep.fill(fTotEdep, 1.0);
   ...
   //new gabriel csv - end of event = end of proton
 //analysisManager->FillNtupleDColumn(0, fTotEdep/eV);
 //analysisManager->FillNtupleDColumn(1, fCluster);
 //analysisManager->FillNtupleSColumn(2, "event"); 

 analysisManager->FillNtupleIColumn(0, 9);
 analysisManager->FillNtupleIColumn(1, 9);
 analysisManager->FillNtupleSColumn(2, "event");
 analysisManager->FillNtupleSColumn(3, "event"); 
 analysisManager->FillNtupleIColumn(4, 9); 
 analysisManager->FillNtupleDColumn(5, 9.9); 
 analysisManager->FillNtupleDColumn(6, 9.9); 
 analysisManager->FillNtupleDColumn(7, 9.9); 
 analysisManager->FillNtupleDColumn(8, 9.9);
 analysisManager->FillNtupleDColumn(9, 9.9); 
 analysisManager->FillNtupleDColumn(10,1.0*fCluster); 
 analysisManager->FillNtupleDColumn(11, fTotEdep/eV); 
 analysisManager->FillNtupleSColumn(12, "event");   
 
 analysisManager->FillNtupleDColumn(13, 9.9); 
 analysisManager->FillNtupleDColumn(14, 9.9); 
 analysisManager->FillNtupleDColumn(15, 9.9); 
 analysisManager->FillNtupleDColumn(16, 9.9); 
 analysisManager->FillNtupleDColumn(17, 9.9); 
 analysisManager->FillNtupleDColumn(18, 9.9); 
 analysisManager->FillNtupleDColumn(19, 9.9); 
 analysisManager->FillNtupleDColumn(20, 9.9); 
